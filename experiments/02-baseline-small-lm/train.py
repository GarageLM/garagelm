...
def main():
    ...
    for it in range(train_cfg.max_iters):
        ...
        # MPS's caching allocator was observed to grow unbounded (63GB for
        # a workload that should need <5GB) with a bigger batch/block_size
        # config — empty_cache periodically as a defensive measure.
