...
def train_step(model, optimizer, model_cfg, train_cfg, train_data, device):
    ...
    Forward/backward run under bf16 autocast (params stay fp32, grads come
    out fp32 -- no GradScaler needed for bf16). Eval stays fp32 so val
    losses compare directly with the control."""
