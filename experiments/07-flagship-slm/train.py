...
DATA_DIR = os.path.join(ROOT, "..", "05-data-frontier", "data")  # same refined pool as 05
...
# states are restored.
STATE_EVERY = 500  # ~1h of work at the 232M model's step time -- the max a restart can lose
