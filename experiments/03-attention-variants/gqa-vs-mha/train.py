...
# Data is NOT re-downloaded/re-tokenized -- the fair-comparison rule
# requires byte-identical data across every variant anyway, so every
# 03-attention-variants/* experiment reads directly from 02's cache.
DATA_DIR = os.path.join(ROOT, "..", "..", "02-baseline-small-lm", "data")
